...
<body>
    ...
    <div id = "loginBanner" class = "flexboxAlign">
        ...
        <div class = "positionSet flexboxAlign">
            ...
            <ol class="breadcrumb flexboxRowAlign noneBackground">
                ...
                <li><a href="promotionForm"><span class = "colorWhite">홍보자료</span></a></li>
            </ol>
        </div>
    </div>
    ...
    <nav id = "nav2" class="navbar navbar-expand-md navbar-light bg-light">
        <div id = "innerNav2" class = "flexboxRowAlign">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <li class="dropdown nav2List flexboxAlign">
                    <a href="/bootstrap/ex05/community/promotion.html" class="nav2ListTitle dropdown-hover" data-hover="dropdown" aria-expanded="true">홍보자료</a>
                    <ul class="dropdown-menu">
                        <li><a class = "navDropText dropdown-item" href="/bootstrap/ex05/community/announce.html">공지사항</a></li>
                        <li><a class = "navDropText dropdown-item" href="/bootstrap/ex05/community/promotion.html">홍보자료</a></li>
                        <li><a class = "navDropText dropdown-item" href="/bootstrap/ex05/community/employ.html">채용안내</a></li>
                    </ul>
                </li>
            </div>
        </div>
    ...
    <!-- ************************************************************************* -->
    <div id = "promotion">
        <div id = "innerpromotion" class = "flexboxAlign">
            <div id = "promTitleDiv" class = "flexboxAlign">
                <p id = "titleOfTitle">홍보자료</p>
                <p id = "textOfTitle">The design and maintenance are excellent.</p>
            </div>
            
            <div id = "promTable" class = "flexboxAlign">
                <table id = "innerPromTable">
                    <tr class = "borderBottomSet">
                        <th class = "headerPercent">제목</th>
                        <td class = "textPercent">${ nDto.news_title }</td>
                    </tr>
                    <tr class = "borderBottomSet">
                        <th class = "headerPercent">작성일</th>
                        <td class = "textPercent">${ nDto.news_date }</td>
                    </tr>
                    <tr class = "borderBottomSet">
                        <td colspan="2">${ nDto.news_content }</td>
                    </tr>
                </table>
            </div>

            <div id = "listButton" class = "flexboxLeftAlign">
                <a href="promotionForm">
                    <button type="button" class="btn promBtn">목록</button>
                </a>
            </div>
        </div>
    </div>
