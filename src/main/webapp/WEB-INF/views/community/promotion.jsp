...
<body>
    ...
    <nav id = "nav2" class="navbar navbar-expand-md navbar-light bg-light">
        <div id = "innerNav2" class = "flexboxRowAlign">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <li class="dropdown nav2List flexboxAlign">
                    <a href="promotionForm" class="nav2ListTitle dropdown-hover" data-hover="dropdown" aria-expanded="true">홍보자료</a>
                    <ul class="dropdown-menu">
    ...
    <!-- ************************************************************************* -->
    <div id = "promotion">
        <div id = "innerProm" class = "flexboxAlign">
            ...
            <div id = "promTable" class = "flexboxAlign">
                <table id = "innerPromTable">
                    ...
                    <c:forEach var = "nDto" items = "${ nList }">
						<tr class = "align">
							<td class = "numberPercent titleCenterAlign">${ nDto.news_idx }</td>
                            <td class = "titlePercent titleLeftAlign"><a href="promotionContent?news_idx=${ nDto.news_idx }">${ nDto.news_title }</a></td>
                            <td class = "datePercent titleCenterAlign">${ nDto.news_date }</td>
						</tr>
					</c:forEach>
                </table>
            </div>
            ...
            <div id = "findInput">
            	<form action = "promotionSearch" method = "post">
