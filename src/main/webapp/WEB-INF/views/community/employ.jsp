...
<body>
    ...
    <div id = "loginBanner" class = "flexboxAlign">
        ...
        <div class = "positionSet flexboxAlign">
            ...
            <ol class="breadcrumb flexboxRowAlign noneBackground">
                ...
                <li><a href="employForm"><span class = "colorWhite">채용안내</span></a></li>
            </ol>
        </div>
    </div>
    ...
    <nav id = "nav2" class="navbar navbar-expand-md navbar-light bg-light">
        <div id = "innerNav2" class = "flexboxRowAlign">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <li class="dropdown nav2List flexboxAlign">
                    <a href="employForm" class="nav2ListTitle dropdown-hover" data-hover="dropdown" aria-expanded="true">채용안내</a>
                    <ul class="dropdown-menu">
    ...
    <!-- ************************************************************************* -->
    <div id = "employ">
        <div id = "innerEmploy" class = "flexboxAlign">
            <div id = "empTitleDiv" class = "flexboxAlign">
                <p id = "titleOfTitle">채용안내</p>
                <p id = "textOfTitle">The design and maintenance are excellent.</p>
            </div>
            
            <div id = "empTable" class = "flexboxAlign">
                <table id = "innerEmpTable">
                    <tr>
               		...
               		<c:forEach var = "jDto" items = "${ jList }">
						<tr class = "align">
							<td class = "numberPercent titleCenterAlign">${ jDto.job_idx }</td>
                            <td class = "titlePercent titleLeftAlign"><a href="employContent?job_idx=${ jDto.job_idx }">${ jDto.job_title }</a></td>
                            <td class = "datePercent titleCenterAlign">${ jDto.job_date }</td>
						</tr>
					</c:forEach>
                </table>
            </div>
            ...
            <div id = "findInput">
            	<form action = "employSearch" method = "post">
