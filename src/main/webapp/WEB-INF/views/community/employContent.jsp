    ...
    <div id = "employ">
        <div id = "innerEmploy" class = "flexboxAlign">
            ...
            <div id = "empTable" class = "flexboxAlign">
                <table id = "innerEmpTable">
                    <tr class = "borderBottomSet">
                        ...
                        <td class = "textPercent">${ jDto.job_title }</td>
                    </tr>
                    <tr class = "borderBottomSet">
                        <th class = "headerPercent">작성일</th>
                        <td class = "textPercent">${ jDto.job_date }</td>
                    </tr>
                    <tr class = "borderBottomSet">
                        <td colspan="2">${ jDto.job_content }</td>
                    </tr>
                </table>
            </div>
            ...
            <div id = "listButton" class = "flexboxLeftAlign">
                <a href="employForm">
                    <button type="button" class="btn empBtn">목록</button>
                </a>
            </div>
        </div>
    </div>
