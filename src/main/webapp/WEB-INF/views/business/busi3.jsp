...
<body>
    ...
    <div id = "loginBanner" class = "flexboxAlign">
        ...
        <div class = "positionSet flexboxAlign">
            ...
            <ol class="breadcrumb flexboxRowAlign noneBackground">
                ...
                <li class = "colorWhite"><a href="busi3Form"><span class = "colorWhite">사업분야03</span></a></li>
            </ol>
        </div>
    </div>
    ...
    <nav id = "nav2" class="navbar navbar-expand-md navbar-light bg-light">
        <div id = "innerNav2" class = "flexboxRowAlign">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <li class="dropdown nav2List flexboxAlign">
                    <a href="busi3Form" class="nav2ListTitle dropdown-hover" data-hover="dropdown" aria-expanded="true">사업분야03</a>
                    <ul class="dropdown-menu">
    ...
    <!-- ***************************************************************************************************************************** -->
    <div id = "business3">
        <div id = "innerBusi" class = "flexboxAlign">
            <div id = "busiTitle" class = "flexboxAlign">
                <p id = "busiTitleOfTitle">사업분야03</p>
                <p id = "busiTextOfTitle">The design and maintenance are excellent.</p>
            </div>

            <div id = "busiMainTextDiv" class = "flexboxAlign">
                <p id = "busiMainTitle">파이브스톤은 끊임없는 열정과 도전으로 가치를 창조합니다.</p>
                <p id = "busiMainText">디자인을 통한 비지니스 네트워크를 구축하여 고객의 필요와 요구를 파악하고 기존 사업과 연계하여 시너지를 창출하며 고객 감동을 실현해 나갈 것입니다. 파이브스톤은 다양한 환경에 적응하며 경쟁하기 위해 모든 기술과 디자인 역량을 집중하고 고객과의 친밀한 소통과 협력을 통해 최고의 품질을 제공하고 있습니다.</p>
            </div>

            <div id = "busiMainContentDiv" class = "flexboxAlign">
                <div class = "innerBusiMainContent flexboxRowAlign">
                    <div id = "content1" class = "contentBox flexboxAlign">
                        <img class = "contentImg" src="http://bdmp-004.cafe24.com/bizdemo99969/img/business/img0301.jpg" alt="content1">
                        
                        <div class = "contentTextBox flexboxLtAlign">
                            <p class = "contentTitle">기업홍보/광고/서비스</p>
                            <p class = "contentText">고객의 필요와 사업환경에 따라 맞춤형 디자인으로 보다 큰 감동을 드립니다.</p>
                        </div>
                    </div>

                    <div id = "content2" class = "contentBox flexboxAlign">
                        <img class = "contentImg" src="http://bdmp-004.cafe24.com/bizdemo99969/img/business/img0302.jpg" alt="content2">
                        
                        <div class = "contentTextBox">
                            <p class = "contentTitle">패션/웨딩/헤어/미용</p>
                            <p class = "contentText">고객의 필요와 사업환경에 따라 맞춤형 디자인으로 보다 큰 감동을 드립니다.</p>
                        </div>
                    </div>

                    <div id = "content3" class = "contentBox flexboxAlign">
                        <img class = "contentImg" src="http://bdmp-004.cafe24.com/bizdemo99969/img/business/img0303.jpg" alt="content3">
                        
                        <div class = "contentTextBox">
                            <p class = "contentTitle">식품/요리/음식/건강</p>
                            <p class = "contentText">고객의 필요와 사업환경에 따라 맞춤형 디자인으로 보다 큰 감동을 드립니다.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class = "innerBusiMainContent flexboxRowAlign">
                    <div id = "content4" class = "contentBox flexboxAlign">
                        <img class = "contentImg" src="http://bdmp-004.cafe24.com/bizdemo99969/img/business/img0304.jpg" alt="content4">
                        
                        <div class = "contentTextBox">
                            <p class = "contentTitle">인테리어/공예/사진</p>
                            <p class = "contentText">고객의 필요와 사업환경에 따라 맞춤형 디자인으로 보다 큰 감동을 드립니다.</p>
                        </div>
                    </div>

                    <div id = "content5" class = "contentBox flexboxAlign">
                        <img class = "contentImg" src="http://bdmp-004.cafe24.com/bizdemo99969/img/business/img0305.jpg" alt="content5">
                        
                        <div class = "contentTextBox">
                            <p class = "contentTitle">여행/팬션/자동차/음악</p>
                            <p class = "contentText">고객의 필요와 사업환경에 따라 맞춤형 디자인으로 보다 큰 감동을 드립니다.</p>
                        </div>
                    </div>

                    <div id = "content6" class = "contentBox flexboxAlign">
                        <img class = "contentImg" src="http://bdmp-004.cafe24.com/bizdemo99969/img/business/img0306.jpg" alt="content6">
                        
                        <div class = "contentTextBox">
                            <p class = "contentTitle">휘트니스/스포츠/병원</p>
                            <p class = "contentText">고객의 필요와 사업환경에 따라 맞춤형 디자인으로 보다 큰 감동을 드립니다.</p>
                        </div>
                    </div>
                </div>
