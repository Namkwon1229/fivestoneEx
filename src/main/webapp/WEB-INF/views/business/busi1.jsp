    ...
    <div id = "business1">
        <div id = "innerBusi" class = "flexboxAlign">
            <div id = "busiTitle" class = "flexboxAlign">
                <p id = "busiTitleOfTitle">사업분야01</p>
            ...
            <div id = "busiMainContentDiv" class = "flexboxAlign">
                <div id = "content1" class = "contentBox flexboxAlign">
                    ...
                    <div class = "contentTextBox">
                        ...
                        <p class = "contentText">급속하게 진화하고 있는 웹기반의 테크놀로지, 인터넷을 무선영역으로 확장하는 새로운 무선 데이터 통신 기술을 근간으로 고객 환경에 맞는 최적화된 서비스를 제공하고 있습니다. 당사의 무선 데이터 통신 서비스는 최고의 품질, 기술, 디자인으로 국내 시장에서 고 부가가치를 지닌 브랜드로 성장하고 있습니다. 아울러 중국, 동남아시아를 비롯한 시장 진입에 이어, EU와 미국 시장 진출을 위한 교두보를 세우고 있습니다.</p>
                    </div>
                </div>

                <div id = "content2" class = "contentBox flexboxAlign">
                    <img class = "contentImg" src="http://bdmp-004.cafe24.com/bizdemo99969/img/business/img0102.jpg" alt="content1">
                ...
                <div id = "content3" class = "contentBox flexboxAlign">
                    <img class = "contentImg" src="http://bdmp-004.cafe24.com/bizdemo99969/img/business/img0103.jpg" alt="content1">
