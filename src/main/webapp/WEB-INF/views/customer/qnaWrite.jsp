...
<body>
    ...
    <div id = "announce">
        <div id = "innerAnnounce" class = "flexboxAlign">
            ...
            <form action = "qnaAddAction" method = "post" id = "qnaInfo" name = "qnaInfo">
				<table id = "innerAnnounTable" class = "flexboxAlign">
                    <tr class = "borderBottomSet">
                        <th class = "headerPercent">제목</th>
                        <td class = "textPercent">
                        	<input type="text" class = "input" id = "qna_title" name = "qna_title"  maxlength = "100">
                        </td>
                    </tr>
                    <tr class = "borderBottomSet">
                        <th class = "headerPercent">작성자</th>
                        <td class = "textPercent">
                        	<input type="text" class = "input" id = "qna_name" name = "qna_name" maxlength = "20">
                        </td>
                    </tr>
                    <tr class = "borderBottomSet">
                        <th class = "headerPercent">비밀번호</th>
                        <td class = "textPercent">
                        	<input type="text" class = "input" id = "qna_pw" name = "qna_pw" maxlength = "20">
                        </td>
                    </tr>
                    <tr class = "borderBottomSet">
                        <td colspan="2">
                        	<input type="text" class = "input" id = "qna_content" name = "qna_content" maxlength = "2000">
                        </td>
                    </tr>
                </table>
	            ...
	            <div id = "listButton" class = "flexboxLeftAlign">
	                ...
	                <button type="submit" class="btn announBtn">작성</button>
	            </div>
            </form>
