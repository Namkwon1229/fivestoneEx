    ...
    <div id = "loginBanner" class = "flexboxAlign">
        ...
        <div class = "positionSet flexboxAlign">
            ...
            <ol class="breadcrumb flexboxRowAlign noneBackground">
                ...
                <li><a href="qnaForm"><span class = "colorWhite">QNA</span></a></li>
            </ol>
        </div>
    </div>
        ...
        <div id = "innerAnnounce" class = "flexboxAlign">
            ...
            <div id = "announTable" class = "flexboxAlign">
                <table id = "innerAnnounTable">
                    <tr>
                        ...
                        <th class = "namePercent">작성자</th>
                        <th class = "datePercent">작성일</th>
                    </tr>

            		<c:forEach var = "qDto" items = "${ qList }">
						<tr class = "align">
							<td class = "numberPercent titleCenterAlign">${ qDto.qna_idx }</td>
                            <td class = "titlePercent titleLeftAlign" onclick= "window.open('qnaPopup?qna_idx=${ qDto.qna_idx }','qna_popup','width=430,height=350,location=no,status=no,scrollbars=yes')" style="cursor:pointer;"><img src = "http://bdmp-004.cafe24.com/bizdemo99969/img/component/board/board_9/icon_sct.gif">${ qDto.qna_title }</td>
                            <td class = "namePercent titleCenterAlign">${ qDto.qna_name }</td>
                            <td class = "datePercent titleCenterAlign">${ qDto.qna_date }</td>
						</tr>
					</c:forEach>					
                </table>
                <a href="qnaAdd">
            ...
            <div id = "findInput">
                <form action = "qnaSearch" method = "post">
					...
					<input type="text" id="qnaSearchWord" name="searchWord">
