...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav m-auto">
                <li class="nav-item d-sm-block d-md-none">
                    <a class="" href="loginForm">LOGIN</a> &nbsp; <a class="joinForm" href="joinForm">JOIN</a>
                </li>
    ...
    <div id = "loginBanner" class = "flexboxAlign">
        ...
        <div class = "positionSet flexboxAlign">
            <p id = "bannerTitle" class = "colorWhite">CUSTOMER</p>
            <ol class="breadcrumb flexboxRowAlign noneBackground">
                ...
                <li class = "colorWhite"><a href="one2oneForm"><span class = "colorWhite">고객지원</span></a>&nbsp>&nbsp</li>
                <li><a href="faqForm"><span class = "colorWhite">FAQ</span></a></li>
            </ol>
        </div>
    </div>
        ...
        <div id = "innerNav2" class = "flexboxRowAlign">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <li class="dropdown nav2List flexboxAlign">
                    <a href="announceForm" class="nav2ListTitle dropdown-hover" data-hover="dropdown" aria-expanded="true">고객지원</a>
                    <ul class="dropdown-menu">
                ...
                <li class="dropdown nav2List flexboxAlign">
                    <a href="qnaForm" class="nav2ListTitle dropdown-hover" data-hover="dropdown" aria-expanded="true">QNA</a>
                    <ul class="dropdown-menu">
                        <li><a class = "navDropText dropdown-item" href="one2oneForm">1:1문의</a></li>
                        <li><a class = "navDropText dropdown-item" href="qnaForm">묻고답하기</a></li>
                        <li><a class = "navDropText dropdown-item" href="faqForm">FAQ</a></li>
                    </ul>
                </li>
            </div>
        </div>
    ...
    <div id = "announce">
        <div id = "innerAnnounce" class = "flexboxAlign">
            <div id = "announTitleDiv" class = "flexboxAlign">
                <p id = "titleOfTitle">묻고답하기</p>
                <p id = "textOfTitle">The design and maintenance are excellent.</p>
            </div>
            
            <form action = "qnaModifyAction" method = "post" id = "qnaInfo" name = "qnaInfo">
				<table id = "innerAnnounTable">
                    <tr class = "borderBottomSet">
                        <th class = "headerPercent">제목</th>
                        <td class = "textPercent">
                        	<input type="text" class = "input" id = "qna_title" name = "qna_title" maxlength = "100" value = "${ qDto.qna_title }">
                        </td>
                    </tr>
                    <tr class = "borderBottomSet">
                        <th class = "headerPercent">작성자</th>
                        <td class = "textPercent">
                        	<input type="text" class = "input" id = "qna_name" name = "qna_name" maxlength = "20" value = "${ qDto.qna_name }">
                        </td>
                    </tr>
                    <tr class = "borderBottomSet">
                        <th class = "headerPercent">비밀번호</th>
                        <td class = "textPercent">
                        	<input type="text" class = "input" id = "qna_pw" name = "qna_pw" maxlength = "20" value = "${ qDto.qna_pw }">
                        </td>
                    </tr>
                    <tr class = "borderBottomSet">
                        <td colspan="2">
                        	<input type="text" class = "input" id = "qna_content" name = "qna_content" maxlength = "2000" value = "${ qDto.qna_content }">
                        </td>
                    </tr>
                    <tr><td><input type = "hidden" id = "qna_idx" name = "qna_idx" value = "${ qDto.qna_idx }"></td></tr>
                </table>

	            <div id = "listButton" class = "flexboxLeftAlign">
	                <a href="qnaForm">
	                    <button type="button" class="btn announBtn">목록</button>
	                </a>
	                <button type="submit" class="btn announBtn">확인</button>
	            </div>
            </form>
