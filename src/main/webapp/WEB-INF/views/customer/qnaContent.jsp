    ...
    <nav id = "nav2" class="navbar navbar-expand-md navbar-light bg-light">
        <div id = "innerNav2" class = "flexboxRowAlign">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <li class="dropdown nav2List flexboxAlign">
                    <a href="faqForm" class="nav2ListTitle dropdown-hover" data-hover="dropdown" aria-expanded="true">FAQ</a>
                    <ul class="dropdown-menu">
    ...
    <div id = "announce">
        <div id = "innerAnnounce" class = "flexboxAlign">
            ...
            <div id = "announTable" class = "flexboxAlign">
                <table id = "innerAnnounTable">
                    <tr class = "borderBottomSet">
                        ...
                        <td class = "textPercent">${ qDto.qna_title }</td>
                    </tr>
                    <tr class = "borderBottomSet">
                        <th class = "headerPercent">작성자</th>
                        <td class = "textPercent">${ qDto.qna_name }</td>
                    </tr>
                    <tr class = "borderBottomSet">
                        <th class = "headerPercent">작성일</th>
                        <td class = "textPercent">${ qDto.qna_date }</td>
                    </tr>
                    <tr class = "borderBottomSet">
                        <td colspan="2">${ qDto.qna_content }</td>
                    </tr>
                </table>
            </div>
            ...
            <div id = "listButton" class = "flexboxLeftAlign">
                ...
                <a href="qnaModify?qna_idx=${ qDto.qna_idx }">
                    <button type="button" class="btn announBtn">수정</button>
                </a>
                <a href="qnaDelete?qna_idx=${ qDto.qna_idx }">
                    <button type="button" class="btn announBtn">삭제</button>
                </a>
                <a href="qnaAdd">
                    <button type="button" class="btn announBtn">글쓰기</button>
                </a>
            </div>
        </div>
    </div>
