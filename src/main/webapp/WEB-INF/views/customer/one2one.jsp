...
<body>
    ...
    <div id = "loginBanner" class = "flexboxAlign">
        <img src="http://bdmp-004.cafe24.com/bizdemo99969/img/main/sub-visual06.jpg" alt="login slide">
            <div class = "positionSet flexboxAlign">
                <p id = "bannerTitle" class = "colorWhite">고객지원</p>
                <ol class="breadcrumb flexboxRowAlign noneBackground">
                    ...
                    <li><a href="one2oneForm"><span class = "colorWhite">1:1문의</span></a></li>
                </ol>
            </div>
    </div>
    ...
    <!-- * one2one 정보 입력 * -->
    <!-- ********************* -->
    <div id = "one2one" class = "flexboxAlign">
    
	    <div id = "innerLogin" class = "flexboxAlign">
	        <p class = "innerTitle">1:1문의</p>
	        <p class = "innerText">The design and maintenance are excellent.</p>
	    </div>
	    
	    <div id = "inputFormWrap" class = "flexboxAlign">
		   <form action = "addOne2one" method = "post" id = "one2oneInfo" name = "one2oneInfo" onsubmit = "return checkValue();">
		   
	    		<table class = "inputTable">
	    		
					<tr class = "borderBottomSet">
						<td class="inputTitle">성명</td>
						<td class="inputContent">
							<input type="text" class = "input" id = "one2one_name" name = "one2one_name">
						</td>
					</tr>
					...
					<tr class = "borderBottomSet">
						...
						<td class="inputContent">
							<input type="text" class = "input" id = "one2one_phone" name = "one2one_phone">
						</td>
					</tr>
					...
					<tr class = "borderBottomSet">
						...
						<td class="inputContent">
							<input type="text" class = "input" id = "one2one_email" name = "one2one_email">
						</td>
					</tr>
					...
					<tr class = "borderBottomSet">
						...
						<td class="inputContent">
							<input type="text" class = "input" id = "one2one_address" name = "one2one_address">
						</td>
					</tr>
					
					<tr class = "borderBottomSet">
						<td class="inputTitle">제목</td>
						<td class="inputContent">
							<input type="text" class = "input" id = "one2one_title" name = "one2one_title">
						</td>
					</tr>
					
					<tr class = "borderBottomSet contentArea">
						<td class="inputTitle">설명</td>
						<td class="inputContent">
							<input type="text" class = "input contentArea" id = "one2one_content" name = "one2one_content">
						</td>
					</tr>
	    		...
	    		<div class = "flexboxRowAlign">
	    			<input class = "classForMargin" type = "image" src="	http://bdmp-004.cafe24.com/bizdemo99969/img/common/btn_confirm.gif" alt="확인">
	    			<a href="index"><img src="http://bdmp-004.cafe24.com/bizdemo99969/img/common/btn_cancel.gif" alt="취소" /></a>
	    		</div>
	    	</form>
	...
	<script>
		function checkValue(){
			...
			if(!document.one2oneInfo.one2one_name.value){
				alert("성명을 입력해주세요");
				document.getElementById('one2one_name').focus();
				return false;
			}
	
			if(!document.one2oneInfo.one2one_phone.value){
				alert("전화번호를 입력해주세요");
				document.getElementById('one2one_phone').focus();
				return false;
			}
			
			if(!document.one2oneInfo.one2one_email.value){
				alert("이메일을 입력해주세요");
				document.getElementById('one2one_email').focus();
				return false;
			}
			
			if(!document.one2oneInfo.one2one_address.value){
				alert("주소를 입력해주세요");
				document.getElementById('one2one_address').focus();
				return false;
			}
			
			if(!document.one2oneInfo.one2one_title.value){
				alert("제목을 입력해주세요");
				document.getElementById('one2one_title').focus();
				return false;
			}
			
			if(!document.one2oneInfo.one2one_content.value){
				alert("설명을 입력해주세요");
