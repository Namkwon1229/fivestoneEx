        ...
        <div id = "innerAnnounce" class = "flexboxAlign">
                ...
                <table id = "innerAnnounTable"> 
                	<tr class = "borderBottomSet">
	            		<c:forEach var = "fDto" items = "${ fList }">
							<tr class = "align">
								<th class = "numberPercent titleCenterAlign">질문</th>
	                            <td class = "titlePercent titleLeftAlign"><a href="faqContent?faq_idx=${ fDto.faq_idx }">${ fDto.faq_title }</a></td>
							</tr>
						</c:forEach>
					</tr>					
                </table>
            ...
            <div id = "findInput">
            	<form action = "faqSearch" method = "post">
            		<select class="selectBox" title="select" name="faqSearchTarget">
						<option value="title">제목</option>
						<option value="content">내용</option>
						<!-- <option value="name">작성자</option> -->
					</select>

					<input type="text" id="faqSearchWord" name="faqSearchWord">
