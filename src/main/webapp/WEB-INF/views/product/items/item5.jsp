            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <li class="dropdown nav2List flexboxAlign">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class = "navDropText dropdown-item" href="#">커뮤니티</a></li>
        ...
        <div id = "innerProd" class = "flexboxAlign">
            ...
            <div id = "mainItemDiv">
                <div id = "itemTitle" class = "flexboxRowAlign">
                    <p id = "justTitle">제목</p>
                    <p id = "itemModelNum">FS104</p>
                </div>

                <div id = "itemMain">
                    <img id = "itemImg" src="http://bdmp-004.cafe24.com/bizdemo99969/component/board/board_10/u_image/53/1869299380_macbook-767806.jpg" alt="item5">
