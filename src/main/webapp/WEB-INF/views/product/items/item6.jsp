...
<body>
    ...
    <div class="top">
        <div class="topMenu d-none d-md-block">
            ...
            <span><a href="./company.html">CONTACT US</a></span>
        </div>
    </div>
    ...
    <nav class="navbar navbar-expand-md navbar-light bg-light sticky-top">
        ...
        <a class="navbar-brand" href="/bootstrap/ex05/index.html">
        ...
        <div id = "innerProd" class = "flexboxAlign">
            ...
            <div id = "mainItemDiv">
                <div id = "itemTitle" class = "flexboxRowAlign">
                    <p id = "justTitle">제목</p>
                    <p id = "itemModelNum">FS103</p>
                </div>

                <div id = "itemMain">
                    <img id = "itemImg" src="http://bdmp-004.cafe24.com/bizdemo99969/component/board/board_10/u_image/52/350176467_fashion-1478813.jpg" alt="item6">
