        ...
        <div id = "innerProd" class = "flexboxAlign">
            ...
            <div id = "mainItemDiv">
                <div id = "itemTitle" class = "flexboxRowAlign">
                    <p id = "justTitle">제목</p>
                    <p id = "itemModelNum">FS102</p>
                </div>

                <div id = "itemMain">
                    <img id = "itemImg" src="http://bdmp-004.cafe24.com/bizdemo99969/component/board/board_10/u_image/51/740729943_product07.jpg" alt="item7">
