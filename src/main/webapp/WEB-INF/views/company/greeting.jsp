...
<body>
    ...
    <div id = "loginBanner" class = "flexboxAlign">
        ...
        <div class = "positionSet flexboxAlign">
            ...
            <ol class="breadcrumb flexboxRowAlign noneBackground">
                ...
                <li class = "colorWhite"><a href="greetingForm"><span class = "colorWhite">CEO인사말</span></a></li>
            </ol>
        </div>
    </div>
    ...
    <nav id = "nav2" class="navbar navbar-expand-md navbar-light bg-light">
        <div id = "innerNav2" class = "flexboxRowAlign">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <li class="dropdown nav2List flexboxAlign">
                    <a href="greetingForm" class="nav2ListTitle dropdown-hover" data-hover="dropdown" aria-expanded="true">CEO인사말</a>
                    <ul class="dropdown-menu">
    ...
    <div id = "greeting" class = "flexboxAlign">
        <div id = "greetingTitleDiv" class = "flexboxAlign">
            <div id = "grtTitle" class = "flexboxAlign">
                <p id = "grtTitleOfTitle">CEO인사말</p>
                <p id = "grtTextOfTitle">The design and maintenance are excellent.</p>
            </div>

            <div id = "grtMain" class = "flexboxRowAlign">
                <div id = "grtImgDiv">
                    <img id = "grtImg" src="http://bdmp-004.cafe24.com/bizdemo99969/img/company/img0201.jpg" alt="greetingImg">
                </div>

                <div id = "grtMsg" class = "flexboxLeftAlign">
                    <p id = "grtMsgTitle">Your good choice. fivestone!!!</p>
                    <p class = "grtMsgText">파이브스톤은 끊임없는 열정과 도전으로 디자인 가치를 창조하고 정직과 신뢰를 기반으로 한 맞춤형 서비스를 통해 고객 한사람 한사람의 필요를 채우고 보다 큰 만족과 감동을 드릴 수 있도록 최선을 다하겠습니다.</p>
                    <p id = "redText" class = "grtMsgText">고객맞춤 디자인수정형의 경우 메인페이지에 보여지는 컨텐츠들의 배열은 고객의 필요와 사업환경에 따라 추가,삭제,이동 등의 수정이 가능합니다. 고객과의 충분한 상담과 협의 후 작업이 진행됩니다.</p>
                    <p class = "grtMsgText">또한 고객의 회사로고에 사용된 색상에 따라 포인트컬러의 변경은 가능합니다. 참고로 현사이트의 포인트컬러는 블루계열의 색상입니다. (전화요망)</p>
                    <p class = "grtMsgText">감사합니다.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div id = "footer">
        <div class = "flexboxAlign innerFooter">
            <div id = "footer1 flexboxAlign">
                <a href="index"><span class = "footer1Text">회사소개</span></a><span class = "footer1Text footer1Slash">|</span>
